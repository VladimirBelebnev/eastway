...
const search = () => {
  ...
  let dpMin, dpMax;
  dpMin = new air_datepicker__WEBPACK_IMPORTED_MODULE_0__["default"]("#from-date", {
    onSelect(_ref) {
      let {
        date
      } = _ref;
  ...
  dpMax = new air_datepicker__WEBPACK_IMPORTED_MODULE_0__["default"]("#to-date", {
    onSelect(_ref2) {
      let {
        date
      } = _ref2;
...
const slider = () => {
  ...
  const tourSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".tour__slider", {
    direction: "horizontal",
    navigation: {
      nextEl: ".tour__next",
      prevEl: ".tour__prev"
